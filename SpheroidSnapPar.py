...
#STEP 1 - Image to gray
main_console.print("[+] Transforming RGB --> grayscale")
gray_image = ski.color.rgb2gray(image)
fig, ax = plt.subplots()
fig.canvas.manager.set_window_title("Grayscale image")
...
thresh = ski.filters.threshold_triangle(gray_image)
